...
To run a script - 
1. Run a command - "composer install" (from the root folder)
2. Then go to the src folder on the command line.
...
____________________________________________________________________________________________
 ...
 # For carpet floor having area 65 - (The robot can clean 1 m2 of carpet in 2 seconds.)
	...
	The robot is cleaning the apartment, which has 65 m square carpet floor.
	The battery is fully charged now.
